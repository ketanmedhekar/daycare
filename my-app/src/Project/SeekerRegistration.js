...
export default class SeekerRegistration extends React.Component{
    constructor(props){
        ...
        this.setState({errors,[nm]:val,first_name_valid:first_name_flag,
            ...
            answer_valid:answer_flag

        },()=>{ this.setState({formvalid:this.state.first_name_valid && this.state.last_name_valid && this.state.email_id_valid && this.state.password_valid && this.state.confirm_password_valid && this.state.contact_no_valid &&this.state.answer_valid})})
        ...
        submitReq = (e) =>{
            ...
            fetch("http://localhost:8080/saveseeker",reqData)
            .then(resp =>
                {
                    if(resp.status == 200)
                    {
            ...
            return(
                <div className="container justify-content-center p-5 mt-5 mb-5 form-reg font-size-form" >
                    <form className="" onSubmit={this.submitReq} >
                        <div className="text-center orangecolor"><h1>Seeker Registration</h1></div>
                        <div class="row m-3">
                            <div class="col-md">
                                <label for="first_name"> First Name : </label>
                                <input  type="text" name="first_name" id="first_name" className=" input-group form-control" required="true" onChange={this.handleChange} />
                                <span className="text-danger">{this.state.errors.first_name_error}</span>
                            </div>
                            <div class="col-md">
                                <label for="last_name">  Last Name : </label>
                                <input type="text" name="last_name" id="last_name" className=" input-group form-control" required="true" onChange={this.handleChange} />
                        ...
                        <div class="row m-3">
                            <div class="col-md">
                                ...
                                <input type="email_id" name="email_id" id="email_id" class=" form-control" required="true" onChange={this.handleChange} />
