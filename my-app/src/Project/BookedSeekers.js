...
export class BookedSeekers extends React.Component{
    ...
    submitReq = (e)=>{
        ...
        const url="http://localhost:8080/getbookedseekersinfo?date="+e.target.date.value+"&daycare_id="+obj.daycare_id;
