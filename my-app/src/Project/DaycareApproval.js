...
export class DaycareApproval extends React.Component{
    ...
    componentDidMount = () =>{
        ...
        fetch("http://localhost:8080/getinvaliddaycare")
    ...
    submitReq(e){
        ...
        const url="http://localhost:8080/validatedaycare?login_id="+e;
                            ...
                            obj=>{ const i=obj.login.login_id
                                ...
                                return(
                                    <tr>
                                        ...
                                        <td>{obj.price}</td>
                                        <td>{obj.timing}</td>
                                        <td><input type="submit" value="Approved" className="submit-reg bgorangecolor"  name="valid" id="valid" onClick={()=>this.submitReq(i)} /></td>
